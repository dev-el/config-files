return {
	...
	config = function()
		...
		submode.create("FindPersist", {
			...
			leave = { "eh", "q", "<ESC>" },
			default = function(register)
				register("n", get_search_list_cmd(0))
				register("h", get_search_list_cmd(1))
				register("m", get_search_list_cmd(2))
				register("u", get_search_list_cmd(3))
				register("ef", get_search_list_cmd(4))
				register("ec", get_search_list_cmd(5))
        register("ej", get_search_list_cmd(6))
				register("f", get_search_list_cmd(7))
				register("k", "n")
				register("i", "N")
				register("j", "/")
				register("tk", "<c-w><c-w>")
